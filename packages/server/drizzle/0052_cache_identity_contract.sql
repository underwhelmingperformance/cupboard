DROP TRIGGER `narinfo_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `narinfo_backfill_update`;--> statement-breakpoint
DROP TRIGGER `pending_upload_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `pending_upload_backfill_update`;--> statement-breakpoint
DROP TRIGGER `pending_attestation_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `pending_attestation_backfill_update`;--> statement-breakpoint
DROP TRIGGER `narinfo_deletion_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `narinfo_deletion_backfill_update`;--> statement-breakpoint
DROP TRIGGER `retention_root_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `retention_root_backfill_update`;--> statement-breakpoint
DROP TRIGGER `retention_root_target_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `retention_root_target_backfill_update`;--> statement-breakpoint
DROP TRIGGER `retention_grace_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `retention_grace_backfill_update`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_revision_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_revision_backfill_update`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_scan_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_scan_backfill_update`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_frontier_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_frontier_backfill_update`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_mark_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_mark_backfill_update`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_tenant_run_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `garbage_collection_tenant_run_backfill_update`;--> statement-breakpoint
DROP TRIGGER `verification_cursor_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `verification_cursor_backfill_update`;--> statement-breakpoint
DROP TRIGGER `retention_policy_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `retention_policy_backfill_update`;--> statement-breakpoint
DROP TRIGGER `cache_identity_backfill_insert`;--> statement-breakpoint
DROP TRIGGER `cache_identity_backfill_revive`;--> statement-breakpoint
