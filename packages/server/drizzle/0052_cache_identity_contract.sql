DROP TRIGGER IF EXISTS `narinfo_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `narinfo_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `pending_upload_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `pending_upload_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `pending_attestation_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `pending_attestation_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `narinfo_deletion_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `narinfo_deletion_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `retention_root_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `retention_root_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `retention_root_target_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `retention_root_target_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `retention_grace_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `retention_grace_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_revision_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_revision_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_scan_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_scan_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_frontier_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_frontier_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_mark_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_mark_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_tenant_run_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `garbage_collection_tenant_run_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `verification_cursor_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `verification_cursor_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `retention_policy_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `retention_policy_backfill_update`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `cache_identity_backfill_insert`;--> statement-breakpoint
DROP TRIGGER IF EXISTS `cache_identity_backfill_revive`;--> statement-breakpoint
...
CREATE TABLE `__new_generation_seq` (
	...
	CONSTRAINT "generation_seq_cache_identity_check" CHECK(("__new_generation_seq"."cache_kind" = 'default' AND "__new_generation_seq"."cache_name" IS NULL) OR ("__new_generation_seq"."cache_kind" = 'named' AND "__new_generation_seq"."cache_name" IS NOT NULL))
);
--> statement-breakpoint
...
CREATE TABLE `__new_cache_identity` (
	...
	`created_at` text NOT NULL,
	`deleted_at` text,
	CONSTRAINT "cache_identity_shape_check" CHECK(("__new_cache_identity"."kind" = 'default' AND "__new_cache_identity"."name" IS NULL) OR ("__new_cache_identity"."kind" = 'named' AND "__new_cache_identity"."name" IS NOT NULL))
);
--> statement-breakpoint
INSERT INTO `__new_cache_identity`("id", "kind", "name", "access", "priority", "generation", "root_retention_rule_set_id", "default_root_ttl_seconds", "grace_seconds", "grace_managed", "created_at", "deleted_at") SELECT "id", "kind", "name", "access", "priority", "generation", "root_retention_rule_set_id", "default_root_ttl_seconds", "grace_seconds", "grace_managed", "created_at", "deleted_at" FROM `cache_identity`;--> statement-breakpoint
...
ALTER TABLE `__new_verification_cursor` RENAME TO `verification_cursor`;--> statement-breakpoint
DROP TABLE `cache_identity_backfill_revision`;
