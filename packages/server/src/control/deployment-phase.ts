 ...
 *
 * A stored phase name that this server version does not define makes this
 * throw. That is what a rollback past a release that added a phase leaves
 * behind, and this version has no behaviour for such a phase.
 */
