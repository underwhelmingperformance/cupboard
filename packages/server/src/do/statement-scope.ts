 ...
 *
 * When no allowance is supplied, use the Workers Free limit. The Durable
 * Object dispatch wrapper supplies the configured allowance.
 */
 ...
 *
 * `allowanceOf` reads the configured allowance from the object handling the
 * dispatch.
 */
