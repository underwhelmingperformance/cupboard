...
/**
 * The prefix of a bundle up to and including one journal index. The catalogue
 * reconciliation runs between two groups of migrations, so it needs the
 * earlier group on its own.
 */
