...
import { cacheLifecycleFilter } from './cache-registration-service.ts';
...
export class DeletionQueueService {
	 ...
	 * `CacheRegistrationService.recordLifecycle` removes the timestamp when the
	 * cache name is registered again.
	 *
