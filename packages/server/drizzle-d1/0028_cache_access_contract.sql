...
--> statement-breakpoint
INSERT INTO `__new_cache_lifecycle`("tenant", "cache_kind", "cache_name", "access", "generation", "deleted_at", "updated_at") SELECT "tenant", "cache_kind", "cache_name", "access", "generation", "deleted_at", "updated_at" FROM `cache_lifecycle`;--> statement-breakpoint
...
ALTER TABLE `tenant` DROP COLUMN `read_mode`;--> statement-breakpoint
ALTER TABLE `tenant` DROP COLUMN `cache_catalogue_version`;
