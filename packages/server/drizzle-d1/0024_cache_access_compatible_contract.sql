...
--> statement-breakpoint
INSERT INTO `__new_cache_lifecycle`("tenant", "cache", "cache_kind", "cache_name", "access", "generation", "deleted_at", "updated_at") SELECT "tenant", "cache", "cache_kind", "cache_name", "access", "generation", "deleted_at", "updated_at" FROM `cache_lifecycle`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `tenant_cache_read_credential_named_identity_idx` ON `tenant_cache_read_credential` (`tenant`,`cache_name`) WHERE "tenant_cache_read_credential"."cache_kind" = 'named';
