DROP TRIGGER `cache_access_native_default_insert`;--> statement-breakpoint
DROP TRIGGER `cache_access_native_default_update`;--> statement-breakpoint
...
DROP TRIGGER `cache_access_native_cache_lifecycle_insert`;--> statement-breakpoint
DROP TRIGGER `cache_access_validate_cache_lifecycle_insert`;--> statement-breakpoint
DROP TRIGGER `cache_access_native_blob_ref_insert`;--> statement-breakpoint
DROP TRIGGER `cache_access_validate_blob_ref_insert`;--> statement-breakpoint
DROP TRIGGER `cache_access_native_attestation_ref_insert`;--> statement-breakpoint
DROP TRIGGER `cache_access_validate_attestation_ref_insert`;--> statement-breakpoint
DROP TRIGGER `cache_access_native_tenant_cache_read_credential_insert`;--> statement-breakpoint
DROP TRIGGER `cache_access_validate_tenant_cache_read_credential_insert`;--> statement-breakpoint
