...
/**
 * The S3 operation selected for a request after considering its method and
...
// `decodeURIComponent` throws for malformed percent encoding. Convert that
// exception into a 400 client error.
