...
export const controlContract = {
	...
	// `cupboard deploy` records how far each schema transition has got, and
	// `deployment.transitions` returns the recorded states.
	deployment: {
	...
	// A release that changes each tenant's local state needs every active or
