...
// The server closes a commit connection with 1008 (policy violation)
// when the access token from its upgrade expires. The client checks both
// values to distinguish an expired token from any other 1008 close.
