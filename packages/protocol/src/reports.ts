...
// grace reporting is enabled, `{}` means that the cache had no grace. The
// property is omitted for collected paths and for legacy responses that do
// not report grace facts.
